...
function createMarkup(countries) {
    ...
    if (countries.length === 1) {
        ...
        markup = countries.map((country)=>{
            ...
            <p><b>Flag</b>: <img width="200" height="100" src="${country.flags.svg}"></p>
...
function searchCountry() {
    ...
    (0, _fetchCountries.fetchCountries)(searchedPhrase).then((countries)=>createMarkup(countries)).catch((error)=>console.log(error));
}
inputEl.addEventListener("input", (0, _lodashDebounceDefault.default)(searchCountry, DEBOUNCE_DELAY));
